...
venn.diagram(orth, filename="Comparison_Node13_pseudos.png", height=2000, width=2000, cex=0.5, cat.cex=0.5, fill=c("#f15bb5","#9b5de5", "#80ed99"), col="white")
...
savehistory("VennCommands_Node13_pseudos.R")
