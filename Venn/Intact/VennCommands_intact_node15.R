...
set.seed(1)
venn.diagram(orth, filename="Comparison_Node15.png", height=2000, width=2000, cex=0.5, cat.cex=0.5, fill=c("#8cb369","#f4e285", "#f4a259"), col="white")
...
savehistory("VennCommands_intact_node15.R")
